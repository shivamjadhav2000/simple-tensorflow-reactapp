...
import './TensorflowExamp.css';

const TensorflowExamp = () => {
    //Value pairs state
    ...
    const handleTrainModel = () => {
        setModelState({
            ...
            predictedValue: 'model is training...',
            trainState:"Red"
        });
        let xValues = [],
            yValues = [];
    ...
    return (
        <div className="tensorflow-example">
            <div className="train-controls">
                ...
                <button
                    className="button-train Green button--green"
            ...
            <div className="predict-controls">
                ...
                <div className={modelState.trainState}>
...
export default TensorflowExamp;